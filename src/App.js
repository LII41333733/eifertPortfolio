    ...
    <svg height="auto" width="960px">
      <defs>
        ...
        <pattern id="imgF" width="100%" height="100%">
          <image id="imageF" href="Animations-overlay.gif" x="0" y="0"></image>
        </pattern>
      ...
      <polygon onClick={() => func("PLCC")} id="polyAA" points="15,15 295,15 380,335 15,335"></polygon>
...
export const PLCC_Details = () => {
  return (
    <div className="details-container">
      <div id="details-info-div">
        <div id="details-name">PLCC</div>
...
export const PLCC_Images = () => {
  return (<>
    ...
    <div id="m-1" className="mobileDiv">
      <img className="mobile-image" src="Textiles.png"></img>
    </div>
    <div className="mobile-line-right"></div>
    <div id="m-2" className="mobileDiv">
      <img className="mobile-image" src="Harlem.png"></img>
    </div>
    <div className="mobile-line-left"></div>
    <div id="m-3" className="mobileDiv">
      <img className="mobile-image" src="BabyDepot.png"></img>
    </div>
    <div className="mobile-line-right"></div>
    <div id="m-4" className="mobileDiv">
      <img className="mobile-image" src="Beauty.png"></img>
    </div>
    <div className="mobile-line-left"></div>
    <div id="m-5" className="mobileDiv">
      <img className="mobile-image" src="Animations-overlay.gif"></img>
    </div>
    <div className="mobile-line-right"></div>
    <div id="m-6" className="mobileDiv">
      <img className="mobile-image" src="Holiday.png"></img>
    </div>
    <div className="mobile-line-left"></div>
    <div id="m-7" className="mobileDiv">
      <img className="mobile-image" src="AOE.png"></img>
    </div>
    <div className="mobile-line-right"></div>
    <div id="m-8" className="mobileDiv">
      <img className="mobile-image" src="Treats.png"></img>
    </div>
    <div className="mobile-line-left"></div>
    <div id="m-9" className="mobileDiv">
      <img className="mobile-image" src="Home.png"></img>
    </div>
    <div className="mobile-line-right"></div>
    <div id="m-10" className="mobileDiv">
      <img className="mobile-image" src="PMGSC.png"></img>
    </div>
    <div className="mobile-line-left"></div>
    <div id="m-11" className="mobileDiv">
      <img className="mobile-image" src="WomenHeart.png"></img>
    </div></>
  )
}
...
function App() {
  ...
  desktopImages = document.getElementsByClassName("desktop-images");
  if (desktopImages.length) {
    page === "home"
      ? document.getElementsByClassName("desktop-images")[0].style.display = "none"
      : document.getElementsByClassName("desktop-images")[0].style.display = "block";
  ...
  const navScroll = () => {
    ...
    if (page !== "home") {
      ...
      container[0].style.height = "6000px"
    } else {
      resetDesktop();
    }
  }
    ...
    <div className={"container"}>
      <div className="desktop">
        <div className={"header"}>
          <img onClick={() => { setPage("home"); resetDesktop(); }} className="logo" src="EifertDesign-Logo" alt="logo"></img>
          <div id="navList">
      ...
      <div className="mobile">
        <img id="logo-mobile" src="EifertDesign-Logo" alt="logo"></img>
        <div id="m-0" className="mobileDiv">
          <img className="mobile-image" src="PLCC.png"></img>
        </div>
        <div className="mobile-line-left"></div>
