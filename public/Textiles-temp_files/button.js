...
function buildCheckoutProps(props) {
  var memoizedPayment = memoize(props.payment || window.xprops.payment); // $FlowFixMe
...
function Native(_ref2) {
  ...
  var props = {
    ...
    createOrder: function createOrder() {
      return window.xprops.payment().then(normalizeECToken);
    },
  ...
  var getServiceData = memoize(function () {
    return promise_ZalgoPromise.hash({
      ...
      return {
        ...
        eligibility: {
          cardFields: false,
          native: nativeEligibility.paypal,
  ...
  return {
    ...
    isPaymentEligible: function isPaymentEligible(_ref5) {
    ...
    start: function start(_ref6) {
      ...
      return getServiceData().then(function (serviceData) {
        ...
        var onApprove = function onApprove(_ref7) {
          var payerID = _ref7.payerID,
              billingToken = _ref7.billingToken;
          return supplementalDataPromise.then(function (_ref8) {
            var orderID = _ref8.orderID,
                paymentID = _ref8.paymentID,
                intent = _ref8.intent,
                returnUrl = _ref8.returnUrl;
